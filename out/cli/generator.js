...
exports.generateAstNode = exports.generateJavaScript = void 0;
...
function generateAstNode(model, filePath, destination) {
    const data = (0, cli_util_1.extractDestinationAndName)(filePath, destination);
    ...
    console.log(model);
    fs_1.default.writeFileSync(generatedFilePath, contents);
    return generatedFilePath;
}
exports.generateAstNode = generateAstNode;
