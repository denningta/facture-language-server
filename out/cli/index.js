...
const facture_module_1 = require("../language-server/facture-module");
const cli_util_1 = require("./cli-util");
// import { generateJavaScript } from './generator';
const node_1 = require("langium/node");
const generator_1 = require("./generator");
const generateAction = (fileName, opts) => __awaiter(void 0, void 0, void 0, function* () {
    const services = (0, facture_module_1.createFactureServices)(node_1.NodeFileSystem).Facture;
    const model = yield (0, cli_util_1.extractAstNode)(fileName, services);
    console.log(model);
    const generatedFilePath = (0, generator_1.generateAstNode)(model, fileName, opts.destination);
...
function default_1() {
    ...
    const fileExtensions = module_1.FactureLanguageMetaData.fileExtensions.join(', ');
    program
        .command('generate')
